...
class AuthToken private constructor(context: Context){
    companion object{
        ...
        fun getInstance(context: Context):AuthToken = Companion.instance?: synchronized(this){
    ...
    var token:String? = null
        set(value) = sharedPreference.edit().putString(TOKEN_VALUE,value)
            .apply().also { field=value }
